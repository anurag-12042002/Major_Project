...
const Navbar = () => {
    ...
    return (
        <div className={`flex items-center justify-between px-6 md:px-6 md:px-16 lg:px-24
         ...
         ${location.pathname === "/" && "bg-light"}`}>
            ...
            {open ? "max-sm:translate-x-0" : "max-sm:translate-x-full"}`}>
                ...
                border-borderColor px-3 rounded-full max-w-56'>
                    ...
                    outline-none placeholder-gray-500" plaeholder="Serach product" />
                ...
                <div className='flex max-sm:flex-col items-start sm:items-center gap-6'>
                    ...
                    <button onClick={() => navigate('/login')} className="cursor-pointer px-8 py-2 bg-primary
