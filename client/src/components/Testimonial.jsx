...
const Testimonial = () => {
    ...
    return (
        <div className="py-28 px-6 md:px-15 lg:px-24 xl:px-44">

            <Title title="What Our Customers Say" subtitle="Discover why discerning travelers choose CarRental for luxury car rentals around the world" />
